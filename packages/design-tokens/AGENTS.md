...
| `temaInstitucional.ts` | Los colores de la marca y los temas claro y oscuro |
...
- **Un color es siempre un ROL**, nunca un valor suelto: asi tiene par de contraste comprobado y
  sigue al tema oscuro.
- **Los dos modos emiten las mismas variables** con valores distintos. Encender el oscuro es

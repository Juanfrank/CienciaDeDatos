...
- Alternativa descartada: definir la alerta sobre un `idDataset` y una expresion. Es mas flexible y es justo lo que sobra — una expresion libre sobre un dataset no tiene ambito que resolver, y reintroduce por la puerta de atras la consulta ad hoc que la seccion 4.2 prohibe.
